# C-Library
A small library of Data Structures and Algorithms in C
...
So this is really just a library of common data structures and algorithms that i otherwise find myself rewriting all the time.
